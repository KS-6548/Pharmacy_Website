...
import { RegisterApi } from "../../Utils/service/Api";
    ...
    <>
      <div className="w-full flex flex-col items-center mt-2.5">
        ...
        }
        {
          ...
          disabled
          className="w-full mt-4 py-2.5 px-[40%] text-white font-semibold text-[12px] rounded-lg bg-primary bg-gradient-to-r from-primary from-20% to-[#87b061] to-100% hover:brightness-[1.03] "
        >
          <div role="status">
            <svg
              aria-hidden="true"
        ...
        <a className="text-xs font-medium decoration-0 mt-2 text-[#c8c8c8cc] cursor-pointer">
